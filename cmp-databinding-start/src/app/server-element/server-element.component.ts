...
@Component({
  ...
  encapsulation: ViewEncapsulation.Emulated // is the default but you can switch between None, Native
})
...
DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnDestroy {
  ...
  ngDoCheck(){// it will slow down the appication if the application is hug 
